...
class NgrokConfig(BaseModel):
    ...
    protocol: str = Field(
        default="http",
        description="Protocol to tunnel (http, tcp, tls)"
    )
    ...
    async def start(self) -> Optional[str]:
        ...
        try:
            ...
            cmd = [
                ...
                "--authtoken", self.config.auth_token.get_secret_value(),
            ...
            logger.error("ngrok executable not found. Install ngrok: https://ngrok.com/download")
            return None
