...
from core.database import (
    get_db_manager,
    Task, Event,
    TaskStatus, TaskPriority, EventType,
    ...
    def sync_task_to_db(
        ...
        with self.db.get_session() as session:
            ...
            if existing:
                ...
                existing.priority = priority_map.get(priority.lower(), TaskPriority.MEDIUM)
                existing.status = status_map.get(status.lower(), TaskStatus.QUEUED)
