...
class AgentCollaborationManager:
    ...
    def acquire_task_lock(
        ...
        with self.db.get_session() as session:
            ...
            if existing_lock is not None and existing_lock.session_id != session_id:
                ...
                if existing_lock.expires_at is not None and existing_lock.expires_at < datetime.utcnow():
    ...
    def _broadcast_help_request(self, request_id: str):
        ...
        with self.db.get_session() as session:
            ...
            for agent in active_agents:
                ...
                caps = agent["capabilities"]
                match_score = self._calculate_capability_match(str(help_req.help_type), caps)
                if match_score > 0.5:
    ...
    def relay_handoff(self, handoff: HandoffObject):
        ...
        from core.db_repositories import HandoffRepository
        with self.db.get_session() as session:
