...
def test_field_types():
    ...
    try:
        ...
        assert hasattr(config.openai_api_key, 'get_secret_value'), "API key should be SecretStr"
...
def test_defaults():
    ...
    try:
        ...
        assert config.artifact_dir == "artifacts/handoff", "Default artifact_dir should be 'artifacts/handoff'"
        assert config.require_consent == True, "Default require_consent should be True"
        assert config.allow_screenshots == False, "Default allow_screenshots should be False"
...
def test_literal_constraints():
    ...
    try:
        ...
        assert config.policy_mode in valid_policy_modes, f"policy_mode must be one of {valid_policy_modes}"
